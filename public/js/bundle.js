    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log("signup route kje andar aya");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
...
var stripe = Stripe('pk_test_51Kg8rjGyJs3D9eOAR5AobWM5I8ERI7ijpzWIH7Al33eJHxTEiRX0RYQBzRv6WRY7QTINIr8brccGStAfaWZHWJkJ00A9qQttpL');
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  console.log("inside index,js" + email);
  var password = document.getElementById('password').value;
  (0, _login.login)(email, password);
});
console.log("signupform value" + signupForm);
if (signupForm) signupForm.addEventListener('submit', function (e) {
  console.log("andar hai signup ke andar aya");
  e.preventDefault();
